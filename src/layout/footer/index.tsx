              ...
              <li className='mb-4'>
                <form className='relative flex items-center'>
                  ...
                  <input
                    ...
                    className='bg-gray-50 p-4 border border-gray-300 text-gray-900 sm:text-sm focus:ring-primary-600 focus:border-primary-600 block w-full transition-colors rounded-full'
                  />
                </form>
              </li>
              <li>
                <div className='flex items-center space-x-2'>
                  ...
                  <p className='text-tertiary-600'>
                    26 Nguyen Tao, Ngu Hanh Son, Danang City
                  </p>
                </div>
              </li>
              <li>
