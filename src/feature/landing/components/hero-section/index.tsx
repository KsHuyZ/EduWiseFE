    ...
    <div>
      <section className='bg-[url(/images/banner.png)] w-full min-h-[500px] pb-36 bg-cover bg-no-repeat bg-center'>
        <div className='px-5 xl:px-0 xl:container'>
          <div className='grid grid-cols-3 pt-48 gap-3'>
            <div className='flex flex-col space-y-8 col-span-2'>
              <h5 className='text-tertiary-600 text-xl font-bold'>
                The Leader in Online Learning
              </h5>
              <h1 className='text-tertiary-800 text-5xl font-extrabold max-w-[500px]'>
              ...
              <div className='flex items-center space-x-10'>
                ...
                <div className='flex items-center space-x-4'>
                  <h1 className='text-tertiary-800 text-5xl font-extrabold'>
                    4.5
                  </h1>
      ...
      <section className='px-5 xl:px-0 xl:container -mt-14'>
