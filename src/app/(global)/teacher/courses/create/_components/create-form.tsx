...
const CreateForm = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      router.push(`/teacher/courses/create/lesson/${result.id}`);
  ...
  return (
    <Form {...form}>
      <form className='py-3 space-y-4' onSubmit={form.handleSubmit(onSubmit)}>
              ...
              <FormItem>
                ...
                <FormControl>
                  <MultipleSelect
                    ...
                    options={[
                      ...(tags ?? []),
                      { id: Math.random().toString(), name: debouncedTagInput },
                    ]}
        ...
        <div className='w-full'>
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>About course</FormLabel>
                <FormControl>
                  <CustomEditor
                    value={field.value}
